...
<ul class="left_menu">
	...
	<div class="right">
			...
			<a href="http://www.xmulife.com/my-profile.htm" <?php echo isset($_checked['profile']) ? $_checked['profile'] : '';?>>基本信息</a>
			<a href="http://www.xmulife.com/my-homepage.htm" <?php echo isset($_checked['homepage']) ? $_checked['homepage'] : '';?>>个人信息</a>
			<a href="http://www.xmulife.com/my-password.htm" <?php echo isset($_checked['password']) ? $_checked['password'] : '';?>>修改密码</a>
			<a href="http://www.xmulife.com/my-avatar.htm" <?php echo isset($_checked['avatar']) ? $_checked['avatar'] : '';?>>修改头像</a>
			...
			<table cellpadding="0" cellspacing="0" width="576" style="table-layout: fixed; margin-top: 8px;">
				<tr>
					<td width="128" valign="top" align="center">
						<a href="http://www.xmulife.com/you-index-uid-<?php echo isset($_user['uid']) ? $_user['uid'] : '';?>.htm" target="_blank" rel="nofollow"><span class="avatar_huge border" style="<?php if($_user['avatar_huge']) { ?>background-image: url(<?php echo isset($_user['avatar_huge']) ? $_user['avatar_huge'] : '';?>);<?php } ?>"></span></a>
					...
					<td valign="top">
						...
						<table cellpadding="0" cellspacing="4" width="96%" align="center">
							<tr valign="top">
								...
								<td width="30%">
									<p style="line-height: 20px;"><span class="grey">主题：</span><a href="http://www.xmulife.com/my-thread.htm" rel="nofollow"><b style="font-size: 14px;"><?php echo isset($_user['threads']) ? $_user['threads'] : '';?></b></p>
									<p style="line-height: 20px;"><span class="grey">帖子：</span><a href="http://www.xmulife.com/you-post-uid-<?php echo isset($_user['uid']) ? $_user['uid'] : '';?>.htm" rel="nofollow"><b style="font-size: 14px;"><?php echo isset($_user['posts']) ? $_user['posts'] : '';?></b></a></p>
								...
								<td width="30%">
									...
									<p style="line-height: 20px;"><span class="grey">关注：</span><a href="http://www.xmulife.com/you-follow-uid-<?php echo isset($_user['uid']) ? $_user['uid'] : '';?>.htm" target="_blank" rel="nofollow"><b style="font-size: 14px;"><?php echo isset($_user['follows']) ? $_user['follows'] : '';?></b></a></p>
									<p style="line-height: 20px;"><span class="grey">粉丝：</span><a href="http://www.xmulife.com/you-followed-uid-<?php echo isset($_user['uid']) ? $_user['uid'] : '';?>.htm" target="_blank" rel="nofollow"><b style="font-size: 14px;"><?php echo isset($_user['followeds']) ? $_user['followeds'] : '';?></b></a></p>
