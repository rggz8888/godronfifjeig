...
class user extends base_model{
	...
	public function format(&$user) {
		...
		if($user['avatar']) {
			...
			$user['avatar_small'] = $this->conf['cloud_url'].'avatar/'.$dir.'/'.$user['uid'].'_small.gif?'.$user['avatar'];
			$user['avatar_middle'] = $this->conf['cloud_url'].'avatar/'.$dir.'/'.$user['uid'].'_middle.gif?'.$user['avatar'];
			$user['avatar_big'] = $this->conf['cloud_url'].'avatar/'.$dir.'/'.$user['uid'].'_big.gif?'.$user['avatar'];
			$user['avatar_huge'] = $this->conf['cloud_url'].'avatar/'.$dir.'/'.$user['uid'].'_huge.gif?'.$user['avatar'];
