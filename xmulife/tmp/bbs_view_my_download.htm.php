	...
	<div class="right">
		...
		<div class="list">
			<table class="table">
				...
				<?php if(!empty($downlist)) { ?>
				<?php if(!empty($downlist)) { foreach($downlist as &$down) {?>
				<tr>
					<td>
						<a href="http://www.xmulife.com/attach-dialog-fid-<?php echo isset($down['attach']['fid']) ? $down['attach']['fid'] : '';?>-aid-<?php echo isset($down['attach']['aid']) ? $down['attach']['aid'] : '';?>-ajax-1.htm" class="ajaxdialog" ajaxdialog="{showtitle: false, cache: true, position: 6, modal: false}" onclick="return false;" target="_blank"><img src="http://xmulife.u.qiniudn.com/view/image/filetype/<?php echo isset($down['attach']['filetype']) ? $down['attach']['filetype'] : '';?>.gif" width="16" height="16" /><?php echo isset($down['attach']['orgfilename']) ? $down['attach']['orgfilename'] : '';?></a>
					</td>
					<td><?php echo isset($down['attach']['filesize_fmt']) ? $down['attach']['filesize_fmt'] : '';?></td>
					<td><?php echo isset($down['golds']) ? $down['golds'] : '';?> 金币</td>
					<td><?php echo isset($down['dateline_fmt']) ? $down['dateline_fmt'] : '';?></td>
					<td><a href="http://www.xmulife.com/my-attachthread-fid-<?php echo isset($down['attach']['fid']) ? $down['attach']['fid'] : '';?>-pid-<?php echo isset($down['attach']['pid']) ? $down['attach']['pid'] : '';?>.htm" target="_blank">点击查看</a></td>
				</tr>
				<?php }} ?>
				<?php } else { ?>
				<tr>
